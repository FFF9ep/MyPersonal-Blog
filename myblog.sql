...
VALUES (
  ...
  (
    ...
    'admin2@yahoo.com',
    'admin2',
    '$2y$10$y7x6xMVQcl03LWt6cgXOwuNqGZdlg07hvmJ.hkd3ODdfJlcK6NujW',
    '2022-09-13 17:56:02'
  ),
  (
    3,
    'admin3@admin3.com',
    'admin3',
    '$2y$10$FOKbQSPt3lc0lXCv2pnItOPvHCm2rYmwu2x2GGFzFXtqW8PEZkoBm',
    '2022-09-14 12:01:43'
  );
-- --------------------------------------------------------
--
...
VALUES (
  ...
  (
    ...
    'user4@gmail.com',
    'user4@gmail.com',
    '$2y$10$Ffo0L/PN1b8zZ53zF0mU2uxURbwtagQqnsdMgbaOTh2CGNBVTrxVa',
    '2022-09-02 19:00:31'
  ),
  (
    5,
    'user5@user.com',
    'user5@user.com',
    '$2y$10$43Sv1j7yR9cz.sD1XnIZO.W16Gr96a0xT6pm5sJr44OVKtfATAlrO',
    '2022-09-02 19:01:36'
  ),
  (
    6,
  ...
  (
    ...
    'new@user.com',
    'new.user',
    '$2y$10$JUi2KLRDYhl9xYVwTuCQTOhezioPYwSMJTE1IUJdG75a4TngGcoUq',
    '2022-09-14 11:43:53'
  ),
  (
    10,
    'user11@user.com',
    'user.new.11',
    '$2y$10$5I6dB6bPgXV0f9OgwKs2GOMAesgeEOfoCauEALSRy8PZG4xwLmlCu',
    '2022-09-14 11:56:15'
  );
--
