...
<head>
    ...
    <link href="http://localhost/fandiblog/css/styles.css" rel="stylesheet" />
</head>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="http://localhost/fandiblog/index.php">Home</a></li>

                    <?php if (isset($_SESSION['username'])) : ?>

                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="http://localhost/fandiblog/posts/create.php">create</a></li>
